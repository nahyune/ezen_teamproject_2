...
export default function RunNotifications({
  ...
  return (
    <div ref={notificationRef} className="relative flex">
      ...
      {open && (
        <section className="absolute right-0 top-[36px] z-[120] w-[360px] max-w-[calc(100vw-36px)] overflow-hidden rounded-[8px] border border-black/8 bg-white text-black shadow-[0_16px_42px_rgba(0,0,0,0.15)]">
